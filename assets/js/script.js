function getPark() {
    ...
    if (skillDropdownValue === "Begginer" && fitnessDropdownValue === "Average") {
        ...
        setTimeout(function () { getPark(document.getElementById("trail-heading").textContent = "Stanmer Park"); }, 5000);
        ...
        setTimeout(function () { getPark(document.getElementById("trail-heading").textContent = "Friston Forest"); }, 5000);
        ...
        setTimeout(function () { getPark(document.getElementById("trail-heading").textContent = "Surrey Hills"); }, 5000);
